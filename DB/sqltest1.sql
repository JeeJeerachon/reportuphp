...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2021 at 10:18 AM
...
(124, 'Surgical', 'Printer', 'asfasf', '16:22:21', '2021-01-28', '', 'สำเร็จ', 'phoomin', 'Sirichai'),
...
(141, 'OPD3', 'Computer', '	\r\nอุปกรณ์ต่าง ๆ ในคอมมีปัญหาทำงานบกพร่องหรือไม่ทำงานอาจเกิดขึ้นจากหลากหลายสาเหตุ จำเป็นที่จะต้องค้นหาสาเหตุเป็นการเฉพาะ ไม่ว่าจะเป็นคีย์บอร์ด เมาส์ ลำโพง เสียงหาย หน้าจอแ', '11:15:07', '2021-02-02', '', 'กำลังดำเนินการ', 'Jeerachon', 'Sirichai'),
(142, 'Labor', 'Computer', '	\r\nอุปกรณ์ต่าง ๆ ในคอมมีปัญหาทำงานบกพร่องหรือไม่ทำงานอาจเกิดขึ้นจากหลากหลายสาเหตุ จำเป็นที่จะต้องค้นหาสาเหตุเป็นการเฉพาะ ไม่ว่าจะเป็นคีย์บอร์ด เมาส์ ลำโพง เสียงหาย หน้าจอแ', '11:15:13', '2021-02-02', '', 'รอช่าง', 'Jeerachon', 'ไม่มี'),
...
(144, 'Office 8', 'Printer', '	\r\nอุปกรณ์ต่าง ๆ ในคอมมีปัญหาทำงานบกพร่องหรือไม่ทำงานอาจเกิดขึ้นจากหลากหลายสาเหตุ จำเป็นที่จะต้องค้นหาสาเหตุเป็นการเฉพาะ ไม่ว่าจะเป็นคีย์บอร์ด เมาส์ ลำโพง เสียงหาย หน้าจอแ', '11:15:23', '2021-02-02', '', 'สำเร็จ', 'Jeerachon', 'Sirichai'),
(145, 'Surgical R', 'เครื่องปริ้น', 'หมึกหมด', '14:33:04', '2021-06-07', '', 'รอช่าง', 'Jeerachon', 'ไม่มี'),
(147, 'Office 2', 'โทรศัพท์', 'aa', '14:55:17', '2021-06-07', '', 'รอช่าง', 'Jeerachon', 'ไม่มี');
...
('teerat', '987654', 'ธีรัช', 'กิจเจริญ', 11223344, 1, '2021-06-15 15:08:07', 'superadmin');
